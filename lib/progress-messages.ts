...
const progressMessages = {
	searching: [
		...
		"Searching and digging deep into investor networks...",
		"Searching and digging deep for the perfect match...",
		"Searching and digging deep in your industry...",
		"Searching and digging deep through investor profiles...",
		"Searching and digging deep to find investors...",
	],
	discovering: [
		"Summarizing the records...",
		"Summarizing investor records...",
		"Summarizing and organizing records...",
		"Summarizing the investor data...",
		"Summarizing records for display...",
