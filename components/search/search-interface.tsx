			...
			<div className="w-full max-w-4xl mx-auto">
				...
				<motion.div
					...
					<motion.div
						...
						className="inline-flex items-center justify-center w-20 h-20 mb-6 rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20">
								...
								<div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
									<div className="flex-1 relative">
										...
										<input
											...
											className="w-full pl-12 pr-4 py-4 bg-transparent text-white placeholder-white/50 dark:placeholder-white/40 text-base sm:text-lg focus:outline-none focus:ring-2 focus:ring-white/50 rounded-2xl"
									...
									<Button
										...
										className="bg-white text-black px-8 py-4 h-auto rounded-2xl font-semibold shadow-lg hover:shadow-xl hover:bg-gray-100 transition-all"
